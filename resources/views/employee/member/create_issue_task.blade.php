	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-2">
					<a href="{{ url('member_task') }}" class="btn btn-primary" 
					style="float:right;">
			...
			@foreach($data['issue'] as $issue)
				<form action="{{  url('edit_task_issue',[$issue->tsid]) }}" method="post">
					@csrf
					<div class="row">
						<div class="col-1">
							<b>{{$loop->iteration}}</b>
						...
						<div class="col-2">
							<div class="form-group">
								...
								<a href="{{url('delete_task_issue',[$issue->tsid])}}"
			...
			@endforeach
			<hr>
			<form action="{{url('add_task_issue',[$data['tid']])}}" method="post">
				@csrf
